        ...
        stage('sonar-cube') {
            steps{
                withSonarQubeEnv('SONAR_CLOUD') {
                    ...
                    sh 'dotnet sonarscanner begin /o:bhavanamangrathi123 /k:bhavanamangrathi123_qt /d:sonar.host.url=https://sonarcloud.io build src/NopCommerce.sln dotnet sonarscanner end'
